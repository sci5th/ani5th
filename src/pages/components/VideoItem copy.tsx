...
const VideoItem: React.FC<VideoItemProps> = ({ video, onSelect }) => {
  ...
  return (
    <div
      className="group relative cursor-pointer overflow-hidden rounded-lg shadow-lg transition-transform duration-300 hover:scale-105 border-2 border-slate-800 hover:border-slate-500"
      onClick={onSelect}
    >
      <div
